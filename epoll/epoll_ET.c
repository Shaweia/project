/*************************************************************************
	> File Name: eopll_ET.c
	> Author: 
	> Mail: 
	> Created Time: Sun 19 Aug 2018 03:29:27 AM PDT
 ************************************************************************/
    ...
    for(;i < num;i++)
    {
        ...
        if(revs[i].events & EPOLLIN)
        {
            if(fd == listen_sock)
            {
                ...
                char *buf = ((epdata_p)(revs[i].data.ptr))->buf;
    ...
    while(1)
    {
        switch((size = epoll_wait(epfd,revs,MAX,-1)))
        {
            ...
            case 0:
                ...
                break;
            default:
                service(epfd,revs,size,listen_sock);
                break;
        }
    }
}
